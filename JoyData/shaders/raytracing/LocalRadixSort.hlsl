...
RWStructuredBuffer<uint> sortedBlocksKeysData; // size = THREADS_PER_BLOCK * BLOCK_SIZE
RWStructuredBuffer<uint> sortedBlocksValuesData; // size = THREADS_PER_BLOCK * BLOCK_SIZE
