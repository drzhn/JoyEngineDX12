...
namespace JoyEngine
{
	...
	public:
		...
		explicit ResourceView(const D3D12_CONSTANT_BUFFER_VIEW_DESC& desc);
		...
		explicit ResourceView(const D3D12_SHADER_RESOURCE_VIEW_DESC& desc, ID3D12Resource* resource);
